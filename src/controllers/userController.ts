 ...
 */
export const syncCurrentUser = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
 ...
 */
export const getKnownUsers = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
